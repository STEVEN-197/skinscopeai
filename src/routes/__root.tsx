...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SkinScope AI — Wellness skin & eye analysis" },
      {
        name: "description",
        content:
          "SkinScope AI helps you monitor visible skin, eye, and palm signs over time using AI-powered image analysis. Educational wellness tool.",
      },
      { name: "author", content: "SkinScope AI" },
      { property: "og:title", content: "SkinScope AI" },
      { property: "og:description", content: "AI-powered wellness monitoring for skin, eyes, and palms." },
